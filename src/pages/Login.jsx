...
export default function Login(){
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto bg-white p-4 rounded-xl border space-y-3">
      <h1 className="text-xl font-bold text-red-500">Ingresar</h1>
      ...
      <button disabled={loading} className="w-full px-4 py-2 rounded bg-red-500 text-white">{loading? 'Ingresando…':'Ingresar'}</button>
    </form>
  )
}